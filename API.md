...
"""
import evo_vad
from evo_vad import VadEngine, VadConfig, VadCallback, VadResult, VadState, VadBackendType
...
class VadConfig:
    ...
    def __init__(self, model_dir: str = "~/.cache/silero_vad"):
        """
        Args:
            model_dir: 模型目录路径
        """
    ...
    @staticmethod
    def silero(model_dir: str = "~/.cache/silero_vad") -> "VadConfig":
        """创建 Silero VAD 配置"""

    @staticmethod
    def energy() -> "VadConfig":
        """创建 Energy VAD 配置"""
