...
try:
    ...
    print("Error: evo_vad module not found.")
...
def main():
    print("=== EvoVAD Python Example ===")
    print(f"Version: {evo_vad.__version__}")
    print()

    # Configuration
    config = evo_vad.VadConfig.silero() \
    ...
    # Create engine
    engine = evo_vad.VadEngine(config)
    ...
    result = evo_vad.detect(audio, sample_rate)
